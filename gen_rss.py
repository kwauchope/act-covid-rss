...
def gen_id(locations):
    ...
    #Would also need to keep past state to know if status=Update means changed since last check anyway
...
def check_exisitng(rss_file, categories):
...
def main():
    ...
    check_exisitng(rss_file, categories)
